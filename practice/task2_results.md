...
| Shkenev Petr                                                       |       43.7        | 1. Conv2D(3x3, Leaky ReLU, stride=2, out=32)<br>2. Conv2D(3x3, Leaky ReLU, stride=2, out=64)<br>3. Conv2D(3x3, Leaky ReLU, stride=2, out=64)<br>4. Conv2D(3x3, Leaky ReLU, stride=2, out=128)<br>5. Fully connected (Leaky ReLU, out=64)<br>6. Fully connected (Leaky ReLU, out=32)<br>7. Fully connected (Leaky ReLU, out=10)<br>8. Softmax |
...
| Levkin Anton                                                  |       51.47       | Dense(3072, 100), 
    ReLu(), 
    Dense(100, 200),
    ReLu(),
    Dense(200, 300),
